...
import TableSold from "../table/TableSold";
import TableProces from "../table/TableProcess";
  ...
  return (
    <div className="ingredeint-operation">
      ...
      <FormControl component="fieldset">
        ...
        >
          <FormControlLabel
            ...
            control={<Radio />}
            label="Number of orders processed over a period of time"
          />
          <FormControlLabel
            value="costoProcess"
            className="radio-button"
      ...
      <div className="admin-table">
        ...
        ) : selectedReport == "costoProcess" ? (
          <>
            <SearchBar placeholder={"Search"} onChange={handleSearchChange} />
            <TableProces refresh={refresh} searchText={searchText} />
          </>
        ) : (
